            ...
            <section id="main-content"> 
                <section class="wrapper site-min-height"> 
                    ...
                    <div class="row mt"> 
						...
						$edit = $_GET['edit'];
						$tampil="SELECT * FROM t_usaha WHERE nik='$edit'";
                        ...
                        <!-- START FORM -->
							<div class="row mt">
								<div class="col-lg-12">
									...
									<form class="form-horizontal style-form" method="post" action="../proses/edit/usaha.php" enctype="multipart/form-data">
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input type="text" class="form-control round-form" placeholder="Masukkan Nama Usaha" name="usaha" value="<?php echo "$r[usaha]"; ?>" required>
											</div>
										</div>
