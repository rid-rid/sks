								...
								<div class="col-lg-12">
									...
									<form class="form-horizontal style-form" method="post" action="../proses/simpan/sub_rekening.php" enctype="multipart/form-data">
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input type="text" class="form-control round-form" placeholder="Masukkan Kode Sub Rekening Sesuai Kode Bidang" name="kd_sub_rekening" id="kd_sub_rekening" required>
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-2 col-sm-2 control-label">Nama Sub Rekening</label>
											<div class="col-sm-10">
												<input type="text" class="form-control round-form" placeholder="Masukkan Nama Sub Rekening" name="nama_sub_rekening" id="nama__sub_rekening" required>
											</div>
										</div>
