...
<html lang="en"> 
    <head> 
        ...
        <title>INPUT SURAT IMUNISASI - Desa Tamban Jaya</title>         
        <!-- Favicons -->         
        ...
        *********************************************************************************************************************************************************** -->             
            ...
            <section id="main-content"> 
                <section class="wrapper site-min-height"> 
                    <h3><b>INPUT DATA PENGAJUAN SURAT IMUNISASI</b></h3> 
                    <div class="row mt"> 
                        <div class="col-lg-12"> 
                        <!-- START FORM -->
							<div class="row mt">
								<div class="col-lg-12">
									...
									<form class="form-horizontal style-form" method="post" action="../proses/simpan/imunisasi.php" enctype="multipart/form-data">
