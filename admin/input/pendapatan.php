                                ...
                                <div class="form-panel">
                                    <form class="form-horizontal style-form" name="formDanaDesa" id="formDanaDesa" method="post" action="../proses/simpan/pendapatan.php" enctype="multipart/form-data">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <select name="kd_pendapatan" id="kd_pendapatan" class="form-control" onchange='changeValueKODEPENDAPATAN(this.value)' required>
                                                    ...
                                                    while ($row = mysql_fetch_array($result)) {
                                                        echo '<option name="kd_pendapatan"  value="' . $row['kd_pendapatan'] . '">' . $row['kd_pendapatan'] . ' - ' . $row['nama_pendapatan'] . '</option>';
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" placeholder="Nama Pendapatan" id="nama" readonly required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 col-sm-2 control-label">Besar Anggaran</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" placeholder="Jumlah Besar Anggaran" name="besar_pendapatan" required>
                                            </div>
                                        </div>
