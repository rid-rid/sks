									...
									<form class="form-horizontal style-form" method="post" action="../proses/simpan/rekening.php" enctype="multipart/form-data">
										<div class="form-group">
											...
											<div class="col-sm-10">
												...
												<select name="kd_bidang" id="kd_bidang" onchange='changeValueKODEBIDANG(this.value)' required>
													...
													echo '<option name="kd_bidang"  value="' . $row['kd_bidang'] . '">' . $row['kd_bidang'] . '		</option>';  
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input type="text" class="form-control round-form" placeholder="Masukkan Nama Bidang" id="nama" readonly required>
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-2 col-sm-2 control-label">Kode Rekening </label>
											<div class="col-sm-10">
												<input type="text" class="form-control round-form" placeholder="Masukkan Kode Rekening Sesuai Kode Bidang" name="kd_rekening" id="kd_rekening" required>
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-2 col-sm-2 control-label">Nama Rekening</label>
											<div class="col-sm-10">
												<input type="text" class="form-control round-form" placeholder="Masukkan Nama Rekening" name="nama_rekening" id="nama_rekening" required>
											</div>
										</div>
