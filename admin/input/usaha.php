...
<head>
	...
	<title>INPUT SURAT KET USAHA - Desa Tamban Jaya</title>
	<!-- Favicons -->
        ...
        *********************************************************************************************************************************************************** -->
		...
		<section id="main-content">
			<section class="wrapper site-min-height">
				<h3><b>INPUT DATA PENGAJUAN SURAT KETERANGAN USAHA</b></h3>
				<div class="row mt">
					<div class="col-lg-12">
						<!-- START FORM -->
						<div class="row mt">
							<div class="col-lg-12">
								<div class="form-panel">
									<form class="form-horizontal style-form" method="post" action="../proses/simpan/usaha.php" enctype="multipart/form-data">
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input type="text" class="form-control round-form" placeholder="Masukkan Nama Usaha" name="usaha" required>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-10">
												...
												$tahun = date('Y');
												$nomor = "/503/Ds-TJ/SK-U/" . $romawi . "/" . $tahun;
												// membaca kode  terbesar dari penomoran yang ada didatabase berdasarkan tanggal
												$query = "SELECT max(no_surat) as maxKode FROM t_usaha WHERE month(tanggal)='$bulan'";
