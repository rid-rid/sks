...
<head>
  ...
  <title>SURAT PENGANTAR SKCK - Desa Tamban Jaya</title>
  <!-- Favicons -->
      ...
      <section class="wrapper site-min-height">
        ...
        <div class="row mt">
          <div class="col-lg-12">
              ...
              <div class="form-panel">
                <div class="adv-table">
                  <table class="table table-striped table-advance table-hover" id="hidden-table-info" width="100%">
                    <h4></i> DATA PENGAJUAN PEMBUATAN SURAT PENGANTAR SKCK</h4>
                    <a href="input/skck.php"><button type="button" class="btn btn-primary btn-lg btn-block"><i class="fa fa-plus"></i>Tambah Data Surat<i class="fa fa-plus"></i></button></a>
                    <hr>
                    <thead>
                      <tr>
                    ...
                    <tbody>
                      ...
                      $tampil = "SELECT * FROM skck ORDER BY tanggal ASC";
            ...
            <div class="row mb">
              <div class="form-panel">
                <form target='_blank' action="cetak/laporan/skck.php" method="POST" class="form-inline" role="form">
