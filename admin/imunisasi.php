...
<html lang="en"> 
    <head> 
        ...
        <title>SURAT IMUNISASI - Desa Tamban Jaya</title>         
        <!-- Favicons -->         
                    ...
                    <div class="row mt"> 
                        <div class="col-lg-12"> 
							...
							<div class="adv-table">
								...
								<h4></i> DATA PENGAJUAN PEMBUATAN SURAT IMUNISASI</h4>
								<a href="input/imunisasi.php"><button type="button" class="btn btn-primary btn-lg btn-block"><i class="fa fa-plus"></i>Tambah Data Surat<i class="fa fa-plus"></i></button></a>
								<hr>
								<thead>
								<tr>
									<th width="6%"><i class="fa fa-sort-numeric-asc"></i> No</th>
									<th><i class="fa fa-leaf"></i> Tanggal Input</th>
									<th><i class="fa fa-exclamation-circle"></i> NIK Suami</th>
									<th><i class="fa fa-group"></i> Nama Suami</th>
								...
								$tampil="SELECT * FROM imunisasi ORDER BY tanggal ASC";
								...
								<tr>
									...
									<td><?php echo "$r[nik_s]"; ?></td>
									<td><?php echo "$r[nama_s]"; ?></td>
							...
							<form target='_blank' action="cetak/laporan/imunisasi.php" method="POST" class="form-inline" role="form">
