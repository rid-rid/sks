...
$perintah=sprintf("INSERT INTO penduduk VALUES('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','$gambar')",
$_POST['nik'],$_POST['nama'],$_POST['tempat'],$_POST['tgl'],$_POST['jenkel'], $_POST['agama'],$_POST['stts'],$_POST['pekerjaan'],$_POST['alamat'],$_POST['rt'],$_POST['rw'],$_POST['desa'],$_POST['kec'],'$gambar');
