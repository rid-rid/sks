...
<head>
  ...
  <title>KTP SEMENTARA - Desa Tamban Jaya</title>
  <!-- Favicons -->
      ...
      <section class="wrapper site-min-height">
        ...
        <div class="row mt">
          <div class="col-lg-12">
              ...
              <div class="form-panel">
                <div class="adv-table">
                  <table class="table table-striped table-advance table-hover" id="hidden-table-info" width="100%">
                    <h4></i> DATA PENGAJUAN PEMBUATAN SURAT KETERANGAN KTP SEMENTARA</h4>
                    <a href="input/ktps.php"><button type="button" class="btn btn-primary btn-lg btn-block"><i class="fa fa-plus"></i>Tambah Data Surat<i class="fa fa-plus"></i></button></a>
                    <hr>
                    <thead>
                      <tr>
                        ...
                        <th><i class=" fa fa-info"></i> Keperluan Surat</th>
                    ...
                    <tbody>
                      ...
                      $tampil = "SELECT * FROM ktps ORDER BY tanggal ASC";
                      ...
                      do { ?>
                        <tr>
                          ...
                          <td>
                            <a href="cetak/surat_ktps.php?cetak=<?php echo $r['id']; ?>" target='_blank'><button class="btn btn-success btn-xs"><i class="fa fa-print"></i></button></a>
                            <a href="edit/ktps.php?edit=<?php echo $r['nik']; ?>"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button></a>
                            <a href="proses/hapus/ktps.php?del=<?php echo $r['id']; ?>" onClick="return confirm('Apakah Ingin Menghapus Data')"><button class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i></button></a>
                          </td>
                        </tr>
                      <?php $no++;
            ...
            <div class="row mb">
              <div class="form-panel">
                <form target='_blank' action="cetak/laporan/ktps.php" method="POST" class="form-inline" role="form">
