...
<html lang="en"> 
    <head> 
        ...
        <title>SURAT KET PENGHASILAN - Desa Tamban Jaya</title>         
        <!-- Favicons -->         
                    ...
                    <div class="row mt"> 
                        <div class="col-lg-12"> 
							...
							<div class="adv-table">
								...
								<h4></i> DATA PENGAJUAN PEMBUATAN SURAT KETERANGAN PENGHASILAN</h4>
								<a href="input/penghasilan.php"><button type="button" class="btn btn-primary btn-lg btn-block"><i class="fa fa-plus"></i>Tambah Data Surat<i class="fa fa-plus"></i></button></a>
								<hr>
								<thead>
								<tr>
									<th width="6%"><i class="fa fa-sort-numeric-asc"></i> No</th>
									<th><i class="fa fa-leaf"></i> Tanggal Input</th>
									<th><i class="fa fa-exclamation-circle"></i> NIK Ayah</th>
									<th><i class="fa fa-group"></i> Nama Ayah</th>
									<th><i class=" fa fa-check"></i> NIK Anak</th>
									<th><i class=" fa fa-star-half-o"></i> Nama Anak</th>
								...
								$tampil="SELECT * FROM penghasilan ORDER BY tanggal ASC";
								...
								<tr>
									...
									<td><?php echo "$r[nik_ay]"; ?></td>
									<td><?php echo "$r[nama_ay]"; ?></td>
									<td><?php echo "$r[nik_an]"; ?></td>
									<td><?php echo "$r[nama_an]"; ?></td>
									...
									<td>
										...
										<a href="proses/hapus/penghasilan.php?del=<?php echo $r['id']; ?>"onClick="return confirm('Apakah Ingin Menghapus Data')"><button class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i></button></a>
									</td>
								</tr>
							...
							<form target='_blank' action="cetak/laporan/penghasilan.php" method="POST" class="form-inline" role="form">
