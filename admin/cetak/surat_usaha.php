...
$tampil="SELECT * FROM t_usaha WHERE id=$_GET[cetak]";
...
<P CLASS="western" ALIGN=JUSTIFY STYLE="text-indent: 0.39in; margin-bottom: 0in; line-height: 115%">
  Bahwa yang bernama tersebut diatas adalah benar-benar penduduk Desa
  Tamban Jaya yang memiliki usaha sebagai <?php echo "$r[usaha]"; ?>.</P>
<P CLASS="western" ALIGN=JUSTIFY STYLE="text-indent: 0.39in; margin-bottom: 0in; line-height: 115%">
Demikian Surat Keterangan  ini dibuat agar dapat di ketahui dan 
dipergunakan sebagai mana mestinya.</P>
