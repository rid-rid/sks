...
KETERANGAN USAHA</FONT>  </H3><br></br>
<table width="100%" border="1" bordercolor="#333333" bordercolorlight="#000000" bordercolordark="#000000" bgcolor="#FFFFFF" frame="box" rules="all">
  <tr>
    <td>No</td>
    <td>NIK</td>
    <td>Nama</td>
...
$from=$_POST['from'];
$to=$_POST['to'];
$tampil="SELECT * FROM t_usaha WHERE tanggal BETWEEN '$from' AND '$to' ";
