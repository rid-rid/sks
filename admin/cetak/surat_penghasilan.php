...
$tampil="SELECT * FROM penghasilan WHERE id=$_GET[cetak]";
...
KETERANGAN PENGHASILAN</FONT></H3>
<blockquote>
  <blockquote>
    <blockquote>
      <blockquote>
...
<?php
$nik_ay=$r['nik_ay'];
$tampil="SELECT * FROM penduduk WHERE nik=$nik_ay";
$query=@mysql_query($tampil,$koneksi) or die (mysql_error());
$rr= @mysql_fetch_assoc($query);
?>
<?php
$nik_an=$r['nik_an'];
$tampil="SELECT * FROM penduduk WHERE nik=$nik_an";
$query=@mysql_query($tampil,$koneksi) or die (mysql_error());
$rrr= @mysql_fetch_assoc($query);
?>
	<TABLE WIDTH=100% CELLPADDING=7 CELLSPACING=0>
		...
		<TR>
			...
			<TD WIDTH=336 align="left" valign="middle" STYLE="border: none; padding: 0in">
				<P><span class="line2"><?php echo "$rr[nama]"; ?></span></P>
			</TD>
		</TR>
		<TR>
			<TD WIDTH=188 align="left" valign="middle" STYLE="border: none; padding: 0in">
			...
			<TD WIDTH=336 align="left" valign="middle" STYLE="border: none; padding: 0in">
				<P><span class="line2"><?php echo "$r[nik_ay]"; ?></span></P>
			</TD>
		</TR>
		<TR>
			<TD WIDTH=188 align="left" valign="middle" STYLE="border: none; padding: 0in">
			...
			<TD WIDTH=336 align="left" valign="middle" STYLE="border: none; padding: 0in">
				<P><span class="line2"><?php echo "$rr[jenkel]"; ?></span></P>
			</TD>
		</TR>
		<TR>
			<TD WIDTH=188 align="left" valign="middle" STYLE="border: none; padding: 0in">
			...
			<TD WIDTH=336 align="left" valign="middle" STYLE="border: none; padding: 0in">
				<P><span class="line2"><?php echo "$rr[tempat]/$rr[tgl]"; ?></span></P>
			</TD>
		</TR>
		<TR>
			<TD WIDTH=188 align="left" valign="middle" STYLE="border: none; padding: 0in">
			...
			<TD WIDTH=336 align="left" valign="middle" STYLE="border: none; padding: 0in">
				<P><span class="line2"><?php echo "$rr[agama]"; ?></span></P>
			</TD>
		</TR>
		<TR>
			<TD WIDTH=188 align="left" valign="middle" STYLE="border: none; padding: 0in">
			...
			<TD WIDTH=336 align="left" valign="middle" STYLE="border: none; padding: 0in">
				<P><span class="line2"><?php echo "$rr[stts]"; ?></span></P>
			</TD>
		</TR>
		<TR>
			<TD WIDTH=188 align="left" valign="middle" STYLE="border: none; padding: 0in">
			...
			<TD WIDTH=336 align="left" valign="middle" STYLE="border: none; padding: 0in">
				<P><span class="line2"><?php echo "$rr[pekerjaan]"; ?></span></P>
			</TD>
		</TR>
		<TR>
			<TD WIDTH=188 align="left" valign="middle" STYLE="border: none; padding: 0in">
			...
			<TD WIDTH=336 align="left" valign="middle" STYLE="border: none; padding: 0in">
				<P><span class="line2"><?php echo "$rr[alamat] RT.$rr[rt]/RW.$rr[rw]"; ?> Kec. Tamban Catur, Kab. Kapuas KALTENG</span></P>
			</TD>
		</TR>
	</TABLE>  
</DL>
<P CLASS="western" ALIGN=JUSTIFY STYLE="text-indent: 0.39in; margin-bottom: 0in; line-height: 115%">
  Adalah ayah dari <?php echo "$rrr[nama]"; ?>,  jenis kelamin <?php echo "$rrr[jenkel]"; ?>, alamat <?php echo "$rrr[alamat]"; ?>  RT.<?php echo "$rrr[rt]"; ?>  RW.<?php echo "$rrr[rw]"; ?>  Kec. Tamban Catur Kab. Kapuas  </P>
<P CLASS="western" ALIGN=JUSTIFY STYLE="text-indent: 0.39in; margin-bottom: 0in; line-height: 115%">
Adapun atas pekerjaan Bapak <?php echo "$rr[nama]"; ?>, memperoleh penghasilan rata-rata sebesar Rp. <?php echo "$r[nominal]"; ?>.- (<?php echo "$r[penulisan]"; ?> Rupiah) setiap bulan.</P>
<P CLASS="western" ALIGN=JUSTIFY STYLE="text-indent: 0.39in; margin-bottom: 0in; line-height: 115%">
